    ...
    <div class="row">
      ...
      <form class="row" action="/courses/{{$course->id}}" method="post">
        ...
        <div class="form-floating mb-3 col-6">
          <input type="text" class="form-control" id="name" name="name" placeholder="" value="{{$course->course_name}}" required>
          <label for="floatingInput">Nombre del Curso</label>
        </div>

        <div class="form-floating mb-3 col-6">
          <input type="number" class="form-control" id="ranking" name="ranking" min="1" max="5" list="rank" value="{{$course->course_ranking}}" required>
          <label for="floatingPassword">Ranking del Curso 1 al 5 </label>
        </div>

        <div class="form-floating mb-3 col-6">
          <input type="text" class="form-control" id="teacher" name="teacher" placeholder="" value="{{$course->course_teacher}}" required>
        ...
        <div class="form-floating mb-3 col-6">
          <select class="form-select " name="status" aria-label="Seleccione" required>
            ...
            <option>{{$course->course_status}}</option>
